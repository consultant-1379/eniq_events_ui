...
/**
 * Grouping View extended in order to handle property changes of the view that need to be saved
 * @author ecarsea
 * @since 2012
 *
 */
public class JSONGridGroupingView extends GroupingView implements IGridView {
