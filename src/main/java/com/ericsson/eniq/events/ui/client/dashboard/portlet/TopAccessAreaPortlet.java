 ...
 *
 */
public class TopAccessAreaPortlet extends AbstractSearchTimeUserComposite implements PortletTemplate {

    private final IMetaReader metaReader;

    private AccessAreaPortletToTabDrillHandler drillDownHandler;
    ...
    @Inject
    public TopAccessAreaPortlet(final IMetaReader metaReader, final IChartPresenter chartPresenter,
    ...
    public void init(final PortletDataType descriptor) {
        ...
        drillDownHandler = new AccessAreaPortletToTabDrillHandler(metaReader, eventBus, descriptor);
